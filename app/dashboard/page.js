...
const inProgressCourses = [
  {
    ...
    progress: 60,
    syllabus: ["Module 1: Introduction", "Module 2: Techniques", "Module 3: Practice"],
  },
  {
    id: 2,
    title: "Educational Psychology",
    progress: 30,
    syllabus: ["Module 1: Introduction", "Module 2: Theories", "Module 3: Applications"],
  },
  {
    id: 3,
    title: "Curriculum Development",
    progress: 80,
    syllabus: ["Module 1: Planning", "Module 2: Implementation", "Module 3: Evaluation"],
  },
];
...
export default function DashboardPage() {
  ...
  const ProfileCard = () => (
    <Paper elevation={3} sx={{ p: 3, mb: 4, display: "flex", alignItems: "center" }}>
      <Avatar src={userData.avatar} alt={userData.name} sx={{ width: 100, height: 100, mr: 3 }} />
      <Box>
        ...
        <CourseCard key={course.id}>
          <CourseContent>
            ...
            <CourseActions>
              ...
              {isProgress && (
                <ActionButton variant="outlined" color="secondary" onClick={() => handleExpandClick(course.id)}>
              ...
              <SyllabusContent>
                <SyllabusList>
                  {course.syllabus.map((module, index) => (
                    <SyllabusListItem key={index} onClick={() => handleModuleClick(course.id, index)}>
                      <ListItemText
  ...
  const DiscussionForum = () => (
    <Box>
      ...
      <Box sx={{ display: "flex", alignItems: "center", mb: 2 }}>
        <Select value={selectedTopic} onChange={handleTopicChange} displayEmpty sx={{ minWidth: 200, mr: 2 }}>
  ...
  return (
    <ThemeProvider theme={theme}>
      ...
      <main style={{ padding: "20px 50px" }}>{renderTabContent()}</main>
    </ThemeProvider>
  );
}
